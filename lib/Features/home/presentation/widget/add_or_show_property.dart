...
//       // Removed fixed height: the container now shrinks to fit its children
...
//                 }
//
//                 // If showing cards, we need a height for the horizontal list
//                 return SizedBox(
//                   height: 220.h, // We still need a height for Horizontal lists
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          // Updated Header with Row to include "View All"
          Row(
            ...
            children: [
              ...
              CustomTextButton(
                onPressed: () {
                  ...
                  // context.pushNamed(AppRouting.m);
                },
