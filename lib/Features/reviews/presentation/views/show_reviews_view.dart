...
import '../widgets/show_reviews_widgets/show_reviews_body.dart';
...
class ShowReviewsView extends StatelessWidget {
  ...
  const ShowReviewsView(
      {super.key, this.isRoom = false, required this.propertyId});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => ReviewsCubit(reviewsRepo: getIt.get<ReviewsRepoImpl>()),
      child: ShowReviewsBody(propertyId: propertyId, isRoom: isRoom),
    );
  }
}