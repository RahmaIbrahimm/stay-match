...
import '../widgets/review_submitted_widgets/recommendations_section.dart';
...
class ReviewSubmittedView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _ReviewSubmittedContent(),
    );
  }
}
...
class _ReviewSubmittedContent extends StatelessWidget {
  const _ReviewSubmittedContent();
