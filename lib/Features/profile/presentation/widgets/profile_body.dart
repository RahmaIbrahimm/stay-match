...
//   String _idImageDisplayStr = "Add Image";
//   @override
//   void initState() {
//     super.initState();
...
//           var governoratesNames = governorates
//               .map((e) => e.nameInEnglish)
//               .toList();
...
//           );
//
//           // Use cubit's filteredCities if a gov is already selected, else use matched gov's cities
...
//           // Sync selected governorate ONCE (not on every build)
...
//             });
//           }
//           if (data?.idImage != null && data!.idImage!.isNotEmpty) {
//             _idImageDisplayStr = "ID Image Uploaded Verified";
//           }
...
//                             UpdateProfileRequest(fullName: val)),
//                   ),
...
//                     onChanged: (val) =>
//                         profileCubit.updateRequest(
//                             UpdateProfileRequest(fieldOfStudy: val)),
//                   ),
//                   SizedBox(height: 16.h),
//                   // Job title
...
//                     onChanged: (val) =>
//                         profileCubit.updateRequest(
//                             UpdateProfileRequest(jobTitle: val)),
//                   ),
//                   SizedBox(height: 16.h),
...
//                       if (resDate != null) {
//                         profileCubit.updateRequest(
//                           UpdateProfileRequest(birthDate: resDate.toString()),
//                         );
//                         formattedBirthDate =
//                             DateFormat('dd/MM/yyyy').format(resDate);
//                         setState(() {});
//                       }
//                     },
//                     child: Container(
//                       padding: EdgeInsets.symmetric(
//                           horizontal: 12.r, vertical: 16.r),
...
//
//                                 final gov = governorates.firstWhereOrNull((e) =>
//                                 e.nameInEnglish == val);
//                                 final firstCity = gov?.citiesAndVillages
//                                     .firstOrNull;
//                                 _cityController.text =
//                                     firstCity?.nameInEnglish ?? '';
//
//                                 profileCubit.updateRequest(
...
//                                 if (firstCity != null) locationCubit.selectCity(
//                                     firstCity);
...
//                                 profileCubit.updateRequest(
//                                   UpdateProfileRequest(city: val),
//                                 );
//                                 var city = cities.firstWhereOrNull((e) =>
//                                 e.nameInEnglish == val);
...
//                   GestureDetector(
//                     onTap: () async {
//                       // Trigger the image picker inside your cubit
//                       await profileCubit.pickIdImage();
//
//                       // Check if a file was successfully picked, then update your persistent display text
//                       if (profileCubit.pickedIdImageFile != null) {
//                         setState(() {
//                           _idImageDisplayStr =
//                           "Selected: ${profileCubit.pickedIdImageFile!
//                               .path
//                               .split('/')
//                               .last}";
//                         });
...
//                       ),
//                       child: Text(
//                           _idImageDisplayStr ?? "memememmeme"), // Will cleanly show existing verification text OR the freshly picked local filename
//                     ),
//                   ), SizedBox(height: 16.h),
...
//                     onChanged: (val) =>
//                         profileCubit.updateRequest(
//                             UpdateProfileRequest(aboutMe: val)),
//                   ),
//                   SizedBox(height: 24.h),
//
//                   ProfileToggleTile(
...
//                     onChanged: (val) =>
//                         profileCubit.updateRequest(
//                             UpdateProfileRequest(password: val)),
//                   ),
...
//                         return null; // only validate if password was filled
//                       if (val == null || val.isEmpty)
