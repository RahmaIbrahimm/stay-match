...
//   final String? stagedFileName;
//   final String? stagedFileBase64;
//   final Set<String> pendingMessageIds;  // ADD
//   final Set<String> failedMessageIds;   // ADD
//
//   const MessageSuccess({
//     required this.messages,
//     this.chatId,
...
//     this.stagedFileName,
//     this.stagedFileBase64,
//     this.pendingMessageIds = const {},   // ADD
//     this.failedMessageIds = const {},    // ADD
//   });
//
//   MessageSuccess copyWith({
//     List<Messages>? messages,
...
//     Set<String>? pendingMessageIds,      // ADD
//     Set<String>? failedMessageIds,       // ADD
//   }) {
//     return MessageSuccess(
//       messages: messages ?? this.messages,
//       chatId: chatId ?? this.chatId,
...
//       stagedFileName: clearFile ? null : (stagedFileName ?? this.stagedFileName),
//       stagedFileBase64: clearFile ? null : (stagedFileBase64 ?? this.stagedFileBase64),
//       pendingMessageIds: pendingMessageIds ?? this.pendingMessageIds,  // ADD
//       failedMessageIds: failedMessageIds ?? this.failedMessageIds,     // ADD
//     );
//   }
//
//   @override
//   List<Object?> get props => [
//     messages, chatId, otherUserName, otherUserProfile,
//     stagedFileName, stagedFileBase64,
//     pendingMessageIds, failedMessageIds,  // ADD
//   ];
// }
