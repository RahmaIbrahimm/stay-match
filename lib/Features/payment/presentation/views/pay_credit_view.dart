...
//               SnackBar(
//                 content: Text(
//                   isCompleted ? 'Payment Successful! 🎉' : 'Payment not completed.',
//                   style: AppStyles.regular14poppins.copyWith(
//                     color: AppColors.textColorWhite,
//                   ),
//                 ),
//                 backgroundColor: isCompleted ? Colors.green : AppColors.textColorError,
...
//                             isLoading: isPaying,
//                             onPressed: () {
//                               context.read<PaymentCubit>().getRedirectLink(bookingId: bookingId);
//                             },
//                           ),
...
//   }
//
//   void _showPaymentResultOverlay(BuildContext context,
...
//                         .cancel_rounded,
//                     size: 64.r,
//                     color: isSuccess ? Colors.green : AppColors.textColorError,
//                   ),
//                   SizedBox(height: 16.h),
//                   Text(
...
//     //     builder: (_) => _PaymentWebViewScreen(
//     //       redirectUrl: redirectUrl,
//     //       successUrlPattern: 'https://yourapp.com/payment/success',
//     //       onSuccess: () {
//     //         context.goNamed(AppRouting.renterBookingsName);
//     //       },
//     //
...
//       MaterialPageRoute(
//         builder: (_) =>
//             _PaymentWebViewScreen(
//               redirectUrl: redirectUrl,
//               successUrlPattern: '',
//               onSuccess: () {},
//               onClose: () {
//                 context.read<PaymentCubit>().checkIfPaid(bookingId: bookingId);
//               },
//             ),
//       ),
//     );
          ...
          WidgetsBinding.instance.addPostFrameCallback((_) {
            AppKeys.rootScaffoldMessengerKey.currentState?.showSnackBar(
              SnackBar(
                ...
                backgroundColor:
                isCompleted ? Colors.green : AppColors.textColorError,
                behavior: SnackBarBehavior.floating,
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(10.r),
                ),
      ...
      MaterialPageRoute(
        builder: (_) => _PaymentWebViewScreen(
          ...
          onClose: () async {
            ...
            if (!cubit.isClosed) {
              cubit.checkIfPaid(bookingId: bookingId);
            }
          },
        ),
      ),
      ...
      child: Column(
        ...
        children: [
          ...
          _CostRow(
            label: 'Monthly Rent',
            value:
            data.monthlyPrice != null ? '${data.monthlyPrice} EGP' : '—',
          ),
          SizedBox(height: 10.h),
          _CostRow(
            label: 'Service Fee',
            value:
            data.monthlyPrice != null ? '${(data.monthlyPrice?.toInt() ?? 0) * 0.3} EGP' : '—',
          ),
          SizedBox(height: 10.h),
          _CostRow(
            label: 'Duration',
            value:
            data.duration != null ? '${data.duration} Months' : '—',
          ),
          SizedBox(height: 10.h),
          SizedBox(height: 16.h),
          Divider(height: 1, color: AppColors.stroke),
...
class _PayNowButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      height: 54.h,
      child: CustomElevatedButton(
        text: isAlreadyPaid ? '✓ Already Paid' : 'Pay $priceLabel Now',
        isLoading: isLoading,
        onPressed: (isLoading || isAlreadyPaid) ? null : onPressed,
        backgroundColor: isAlreadyPaid ? Colors.green : AppColors.primary,
        textColor: AppColors.textColorWhite,
        textStyle: AppStyles.bold16poppins,
        borderRadius: 14,
        suffixIcon: (isLoading || isAlreadyPaid)
            ? null
            : Icon(
          Icons.lock_outline,
          size: 18.r,
  ...
  void initState() {
    ...
    _controller = WebViewController()
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          onNavigationRequest: (request) {
            if (widget.successUrlPattern.isNotEmpty &&
                request.url.startsWith(widget.successUrlPattern)) {
              widget.onSuccess();
              Navigator.of(context).pop();
              return NavigationDecision.prevent;
            }
