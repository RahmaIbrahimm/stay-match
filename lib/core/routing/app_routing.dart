...
//         builder: (context, state) => const SecondarySplashView(), // Your smooth animation splash screen!
//       ),
//       // ---------------- AUTH ROUTES ----------------
//       GoRoute(
//         path: loginView,
...
class AppRouting {
  ...
  static const roomDetailsViewPath = 'room-details/:roomId/:isMyProperty';
  static const roomDetailsViewName = 'roomDetails';
              ...
              routes: [
                GoRoute(
                  ...
                  builder: (context, state) {
                    ...
                    // 🌟 Fix: Convert to lowercase and handle fallback safely
                    final isMyPropertyStr = state.pathParameters['isMyProperty']?.toLowerCase();
                    final isMyProperty = bool.tryParse(isMyPropertyStr ?? 'false') ?? false;
